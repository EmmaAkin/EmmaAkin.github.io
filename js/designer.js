$(document).ready(function() {
    ...
    Backstretch Images
    ==============================================*/
    $.backstretch('images/header-bg.jpg' /*tpa=http://imapnigeria.com/images/header-bg.jpg*/ );

    $('body').append('<img class="preload-image" src="images/contact-bg.jpg"/*tpa=http://www.imapnigeria.com/js/images/contact-bg.jpg*/ style="display:none;"/>');
    ...
    $('#about').waypoint(function(direction) {
        ...
        if (direction == 'down') {
            $.backstretch('images/contact-bg.jpg' /*tpa=http://www.imapnigeria.com/emma/js/assets/contact-bg.jpg*/ );
        } else {
            $.backstretch('images/header-bg.jpg' /*tpa=http://www.imapnigeria.com/emma/js/assets/header-bg.jpg*/ );
        }
    });
